...
foreach my $c1(@characters){
	...
	system("echo \"        0: = $bin1A;\" >> $hex.v");
        system("echo \"        1: = $bin1B;\" >> $hex.v");
        system("echo \"        2: = $bin1C;\" >> $hex.v");
        system("echo \"        3: = $bin1D;\" >> $hex.v");
        system("echo \"        4: = $bin2A;\" >> $hex.v");
        system("echo \"        5: = $bin2B;\" >> $hex.v");
        system("echo \"        6: = $bin2C;\" >> $hex.v");
        system("echo \"        7: = $bin2D;\" >> $hex.v");

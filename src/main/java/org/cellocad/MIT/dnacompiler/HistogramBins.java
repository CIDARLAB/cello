...
public class HistogramBins {
    ...
    @Getter @Setter private double _LOGMAX;  //3.0;  // REU = 1000
    @Getter @Setter private double _LOGMIN;  //-3.0; // REU = 0.001
    @Getter @Setter private int _NBINS;      //250;

    @Getter @Setter private double[] _LOG_BIN_CENTERS; //double reu_value = _LOG_BIN_CENTERS[20]

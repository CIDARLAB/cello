...
public class ConstraintFileWriter {
    ...
    public static void main(String args[]) {
        ...
        all_json_objects.addAll(new collection_writer_gate_toxicity().getObjects());
        all_json_objects.addAll(new collection_writer_gate_cytometry().getObjects());
        all_json_objects.addAll(new collection_writer_tandem_promoters().getObjects());

        String rootPath = collection_writer.getRootPath();
        prettyPrintJSONArray(all_json_objects, rootPath + "/resources/UCF/EcoJS4ib_110215.UCF.json", false);

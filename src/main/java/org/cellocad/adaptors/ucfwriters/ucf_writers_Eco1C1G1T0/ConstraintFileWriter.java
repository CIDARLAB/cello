...
public class ConstraintFileWriter {
    ...
    public static void main(String args[]) {
        ...
        all_json_objects.addAll(new collection_writer_motif_library().getObjects());
        ...
        prettyPrintJSONArray(all_json_objects, rootPath + "/resources/UCF/Eco1C1G1T0.UCF.json", false);
